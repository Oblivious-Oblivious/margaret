...
static void write_offset_and_line_number_on(
  string *disassembled_instruction, chunk *chunk, size_t offset
) {
...
static size_t inspect_instruction(vector *res, chunk *chunk, size_t offset) {
  ...
  //     return instruction_array_type_word(res, "PUT_TUPLE_WORD", chunk,
  //     offset);
  // case OP_PUT_TUPLE_DWORD:
  //     return instruction_array_type_dword(res, "PUT_TUPLE_DWORD", chunk,
  //     offset);
  case OP_PUT_HASH:
  ...
  case OP_PUT_HASH_DWORD:
    ...
    //     return instruction_array_type_word(res, "PUT_BITSTRING_WORD", chunk,
    //     offset);
