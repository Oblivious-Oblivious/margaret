...
module(c_functions_spec, {
    it("parses C function definitions", {
        parse("###void f()", vector_new(FM_START_C_FUNCTION, FM_LOCAL, string_new("void"), FM_LOCAL, string_new("f"), FM_TENSOR, string_new("0"), FM_END_C_FUNCTION));
        ...
        parse("###int f3(void)", vector_new(FM_START_C_FUNCTION, FM_LOCAL, string_new("int"), FM_LOCAL, string_new("f3"), FM_TENSOR, string_new("0"), FM_END_C_FUNCTION));
