...
module(assignments_spec, {
    it("parses assignments", {
        ...
        parse("(x = (y = 6) + 1)", marg_vector_new(FM_INTEGER, marg_string_new("6"), FM_STORE, marg_string_new("y"), FM_1, FM_BINARY, marg_string_new("+"), FM_STORE, marg_string_new("x")));
        ...
        parse("@x = x + 2", marg_vector_new(FM_VARIABLE, marg_string_new("x"), FM_2, FM_BINARY, marg_string_new("+"), FM_STORE_INSTANCE, marg_string_new("x")));
        ...
        parse("(a = 2, b = 3, c = a = b)", marg_vector_new(FM_2, FM_STORE, marg_string_new("a"), FM_INTEGER, marg_string_new("3"), FM_STORE, marg_string_new("b"), FM_VARIABLE, marg_string_new("b"), FM_STORE, marg_string_new("a"), FM_STORE, marg_string_new("c")));
        parse("((a = 2), (b = 3), (c = a = b))", marg_vector_new(FM_2, FM_STORE, marg_string_new("a"), FM_INTEGER, marg_string_new("3"), FM_STORE, marg_string_new("b"), FM_VARIABLE, marg_string_new("b"), FM_STORE, marg_string_new("a"), FM_STORE, marg_string_new("c")));
    ...
    it("parses assignments as a plain message on non assignable values", {
        parse("[a, b, c] = [1, 2, 3]", marg_vector_new(FM_VARIABLE, marg_string_new("a"), FM_VARIABLE, marg_string_new("b"), FM_VARIABLE, marg_string_new("c"), FM_TENSOR, marg_string_new("3"), FM_1, FM_2, FM_INTEGER, marg_string_new("3"), FM_TENSOR, marg_string_new("3"), FM_BINARY, marg_string_new("=")));
        ...
        parse("2 = 3 + 4", marg_vector_new(FM_2, FM_INTEGER, marg_string_new("3"), FM_BINARY, marg_string_new("="), FM_INTEGER, marg_string_new("4"), FM_BINARY, marg_string_new("+")));
    });
})
