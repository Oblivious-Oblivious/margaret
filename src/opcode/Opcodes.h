...
#define FM_CHAR              marg_string_new("CHAR")
#define FM_STRING            marg_string_new("STRING")
#define FM_TENSOR            marg_string_new("TENSOR")
#define FM_TUPLE             marg_string_new("TUPLE")
#define FM_BITSTRING         marg_string_new("BITSTRING")
#define FM_HASH              marg_string_new("HASH")

#define FM_ANY_OBJECT        marg_string_new("ANY_OBJECT")
#define FM_METHOD_PARAMETER  marg_string_new("METHOD_PARAMETER")

#define FM_START_PROC        marg_string_new("START_PROC")
#define FM_END_PROC          marg_string_new("END_PROC")
