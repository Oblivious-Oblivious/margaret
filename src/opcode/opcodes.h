...
#define OP_POP       ((Instruction)0x0a)
#define OP_TENSOR    ((Instruction)0x0b)
#define OP_TUPLE     ((Instruction)0x0c)
#define OP_TABLE     ((Instruction)0x0d)
#define OP_BITSTRING ((Instruction)0x0e)
#define OP_PRIM      ((Instruction)0x0f)
#define OP_SEND      ((Instruction)0x10)
#define OP_PCALL     ((Instruction)0x11)
#define OP_PCALLARGS ((Instruction)0x12)
#define OP_RAISE     ((Instruction)0x13)
#define OP_EXACTREC  ((Instruction)0x14)
#define OP_ASSIGN    ((Instruction)0x15)
