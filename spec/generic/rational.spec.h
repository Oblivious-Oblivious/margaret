...
module(rational_spec, {
    it("parses rational literals", {
        parse("1r", marg_vector_new(FM_1, FM_UNARY, marg_string_new("r")));
        parse("2/3r", marg_vector_new(FM_2, FM_INTEGER, marg_string_new("3"), FM_UNARY, marg_string_new("r"), FM_BINARY, marg_string_new("/")));
        parse("-1r", marg_vector_new(FM_MINUS_1, FM_UNARY, marg_string_new("r")));
        ...
        parse("2/(-3r)", marg_vector_new(FM_2, FM_INTEGER, marg_string_new("-3"), FM_UNARY, marg_string_new("r"), FM_BINARY, marg_string_new("/")));
        parse("-2/(-3r)", marg_vector_new(FM_INTEGER, marg_string_new("-2"), FM_INTEGER, marg_string_new("-3"), FM_UNARY, marg_string_new("r"), FM_BINARY, marg_string_new("/")));
        parse("+1 / (+3r)", marg_vector_new(FM_1, FM_INTEGER, marg_string_new("3"), FM_UNARY, marg_string_new("r"), FM_BINARY, marg_string_new("/")));
        ...
        parse("2/4r", marg_vector_new(FM_2, FM_INTEGER, marg_string_new("4"), FM_UNARY, marg_string_new("r"), FM_BINARY, marg_string_new("/")));
    });
