...
module(TokenSpec, {
    it("has a type and a value", {
        ...
        assert_that_charptr(string_get(tok->value) equals to "42");
    ...
    it("has an equals message for values", {
        Token *tok1 = token_new(string_new("hello"), TOKEN_STRING, 10, "file3.marg");
        Token *tok2 = token_new(string_new("hello"), TOKEN_STRING, 12, "file3.marg");
