...
module(date_time_spec, {
    it("parses dates", {
        ...
        parse("(x = Date days_in_month: 2 for_year: 1978)", marg_vector_new(FM_VARIABLE, marg_string_new("Date"), FM_INTEGER, marg_string_new("2"), FM_INTEGER, marg_string_new("1978"), FM_KEYWORD, marg_string_new("days_in_month:for_year:"), marg_string_new("2"), FM_STORE, marg_string_new("x"))); // 28 or 29
        ...
        parse("(x = Date name_of_day: 1)", marg_vector_new(FM_VARIABLE, marg_string_new("Date"), FM_INTEGER, marg_string_new("1"), FM_KEYWORD, marg_string_new("name_of_day:"), marg_string_new("1"), FM_STORE, marg_string_new("x"))); // Monday
