...
module(numeric_spec, {
    it("parses numeric expressions", {
        ...
        parse("(0,0,0)", vector_new(FM_INTEGER, string_new("0"), FM_INTEGER, string_new("0"), FM_INTEGER, string_new("0")));
        parse("(42)", vector_new(FM_INTEGER, string_new("42")));
        parse("(41, 42, 43)", vector_new(FM_INTEGER, string_new("41"), FM_INTEGER, string_new("42"), FM_INTEGER, string_new("43")));
        parse("(41, (42), 43)", vector_new(FM_INTEGER, string_new("41"), FM_INTEGER, string_new("42"), FM_INTEGER, string_new("43")));
        parse("(-41 - (-42))", vector_new(FM_INTEGER, string_new("-41"), FM_INTEGER, string_new("-42"), FM_BINARY, string_new("-")));
        parse("((-41), (-42))", vector_new(FM_INTEGER, string_new("-41"), FM_INTEGER, string_new("-42")));
        parse("(42 - 41)", vector_new(FM_INTEGER, string_new("42"), FM_INTEGER, string_new("41"), FM_BINARY, string_new("-")));
    });
    ...
    it("parses float literals", {
        ...
        parse("-42.0", vector_new(FM_FLOAT, string_new("-42.0")));
        parse("986513.00056129", vector_new(FM_FLOAT, string_new("986513.00056129")));
        parse("-986513.00056129", vector_new(FM_FLOAT, string_new("-986513.00056129")));
        parse("1234 e: -2", vector_new(FM_INTEGER, string_new("1234"), FM_INTEGER, string_new("-2"), FM_KEYWORD, string_new("e:"), string_new("1")));
        parse("1234 E: -2", vector_new(FM_INTEGER, string_new("1234"), FM_INTEGER, string_new("-2"), FM_KEYWORD, string_new("E:"), string_new("1")));
        parse("1.234 e: 1", vector_new(FM_FLOAT, string_new("1.234"), FM_INTEGER, string_new("1"), FM_KEYWORD, string_new("e:"), string_new("1")));
        parse("1.234 E: 1", vector_new(FM_FLOAT, string_new("1.234"), FM_INTEGER, string_new("1"), FM_KEYWORD, string_new("E:"), string_new("1")));
    });
    ...
    it("parses negative characters", {
        ...
        parse("-'æ'", vector_new(FM_STRING, string_new("æ")));
    });
})
