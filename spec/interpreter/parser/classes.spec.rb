    ...
    context "on classes" do
        it "parses generating an object with inheritance" do
            parse(%Q{(
                ...
                p2 calc puts,
                (p1 + p2 calc) puts
            )}, %Q{(= Point subclass Object, attr_reader: Point new Tuple (:"x", :"y"), message: Point (:"x": :"xparam", :"y": :"yparam", (:"(", :"@", :"x", :"=", :"xparam", :",", :"@", :"y", :"=", :"yparam", :",", :"self", :")")), new: Comment "->(:xparam, :yparam, (@x = xparam, @y = yparam, self))", message: Point (:"calc", (:"(", :"@", :"x", :"+", :"@", :"y", :")")), new: Comment "->(@x + @y)", message: Point (:"+", :"other", (:"(", :"@", :"x", :"=", :"@", :"x", :"+", :"other", :"x", :",", :"@", :"y", :"=", :"@", :"y", :"+", :"other", :"y", :",", :"self", :")")), new: Comment "->(:other, (@x = @x + other x, @y = @y + other y, self))", = Point3D subclass Point, attr_reader: Point new Tuple (:"z"), message: Point3D (:"x": :"x", :"y": :"y", :"z": :"z", (:"(", :"super", :"x", :":", :"@", :"x", :"y", :":", :"@", :"y", :",", :"@", :"z", :"=", :"z", :",", :"self", :")")), message: Point3D (:"calc", (:"(", :"super", :"calc", :"+", :"@", :"z", :")")), message: Point3D (:"+", :"other", (:"(", :"super", :"+", :"other", :",", :"@", :"z", :"=", :"@", :"z", :"+", :"other", :"z", :",", :"self", :")")), = p1 x:y:z: Point3D 10 20 30, = p2 x:y:z: Point3D 2 4 6, puts (calc p1), puts (calc p2), puts (+ p1 calc p2))});
        end
    end
end
