...
module(InspectorSpec, {
    ...
    it("tests multiple long temporaries", {
        ...
        for(int i = 0; i <= 4000; i++) {
            ...
            chunk_add(bytecode, OP_PUT_OBJECT_DWORD, 123);
        ...
        assert_that_charptr(string_get(vector_get(res, 4000)) equals to "4e20         |      09 00 00 0f a0      PUT_OBJECT_DWORD         42.42 @[4000]");
    });
})
