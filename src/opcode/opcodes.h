...
#define OP_TENSOR    ((Instruction)0x0f)
#define OP_TUPLE     ((Instruction)0x10)
#define OP_TABLE     ((Instruction)0x11)
#define OP_BITSTRING ((Instruction)0x12)
#define OP_PRIM      ((Instruction)0x13)
#define OP_SEND      ((Instruction)0x14)
#define OP_RAISE     ((Instruction)0x15)
#define OP_EXACTREC  ((Instruction)0x16)
#define OP_ASSIGN    ((Instruction)0x17)
