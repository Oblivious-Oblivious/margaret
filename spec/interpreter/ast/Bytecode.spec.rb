...
describe Bytecode do
    ...
    it "emits for binaries" do
        ...
        opcodes("(
            x = 0b0101 + 0b1011,
            x to_int puts,
        )", ["store", "x", "push_binary", "0b0101", "push_binary", "0b1011", "binary", "+", "push_variable", "x", "unary", "to_int", "unary", "puts", "push_variable", "List", "push_2", "keyword", "new:", "1", "pop"]);
    end
    ...
    it "emits for hexadecimals" do
        ...
        opcodes("-0X0427", ["push_hexadecimal", "-0x0427", "pop"]);
        opcodes("x = 0xbeef to_bin to_int puts", ["store", "x", "push_hexadecimal", "0xbeef", "unary", "to_bin", "unary", "to_int", "unary", "puts", "pop"]);
    ...
    it "emits for octals" do
        ...
        opcodes("-0O0210", ["push_octal", "-0o0210", "pop"]);
        opcodes("x = 0o751 to_hex to_bin to_int puts", ["store", "x", "push_octal", "0o751", "unary", "to_hex", "unary", "to_bin", "unary", "to_int", "unary", "puts", "pop"]);
    ...
    it "emits for associations" do
        opcodes("a: 1", ["push_symbol", %Q{"a"}, "push_1", "keyword", "key:value:", "2", "pop"]);
        opcodes(%Q{"b": 2}, ["push_string", %Q{"b"}, "push_2", "keyword", "key:value:", "2", "pop"]);
        opcodes(":c: 3", ["push_symbol", %Q{"c"}, "push_integer", "3", "keyword", "key:value:", "2", "pop"]);
    end
    ...
    it "emits for symbols" do
        opcodes(":symb", ["push_symbol", %Q{"symb"}, "pop"]);
        opcodes(":*", ["push_symbol", %Q{"*"}, "pop"]);
        opcodes(%Q{:"a symbol"}, ["push_symbol", %Q{"a symbol"}, "pop"]);
    end
    ...
    it "emits for lists" do
        ...
        opcodes(%Q{(1, "2", :"3", 42.42)}, ["push_1", "push_string", %Q{"2"}, "push_symbol", %Q{"3"}, "push_float", "42.42", "push_variable", "List", "push_integer", "4", "keyword", "new:", "1", "pop"]);
    end
    ...
    it "emits for hashes" do
        ...
        opcodes("{a: {}, b: {}}", ["push_variable", "Hash", "push_symbol", %Q{"a"}, "push_variable", "Hash", "push_variable", "List", "push_0", "keyword", "new:", "1", "keyword", "new:", "1", "keyword", "key:value:", "2", "push_symbol", %Q{"b"}, "push_variable", "Hash", "push_variable", "List", "push_0", "keyword", "new:", "1", "keyword", "new:", "1", "keyword", "key:value:", "2", "push_variable", "List", "push_2", "keyword", "new:", "1", "keyword", "new:", "1", "pop"]);
        opcodes("{a: 1, b: 2, c: 3}", ["push_variable", "Hash", "push_symbol", %Q{"a"}, "push_1", "keyword", "key:value:", "2", "push_symbol", %Q{"b"}, "push_2", "keyword", "key:value:", "2", "push_symbol", %Q{"c"}, "push_integer", "3", "keyword", "key:value:", "2", "push_variable", "List", "push_integer", "3", "keyword", "new:", "1", "keyword", "new:", "1", "pop"]);
    ...
    it "emits for quoted lists" do
        opcodes("`()", ["push_symbol", %Q{"("}, "push_symbol", %Q{")"}, "push_variable", "List", "push_2", "keyword", "new:", "1", "pop"]);
        opcodes("`(a b c)", ["push_symbol", %Q{"("}, "push_symbol", %Q{"a"}, "push_symbol", %Q{"b"}, "push_symbol", %Q{"c"}, "push_symbol", %Q{")"}, "push_variable", "List", "push_integer", "5", "keyword", "new:", "1", "pop"]);
        opcodes("`(:a msg: :b)", ["push_symbol", %Q{"("}, "push_symbol", %Q{":"}, "push_symbol", %Q{"a"}, "push_symbol", %Q{"msg"}, "push_symbol", %Q{":"}, "push_symbol", %Q{":"}, "push_symbol", %Q{"b"}, "push_symbol", %Q{")"}, "push_variable", "List", "push_integer", "8", "keyword", "new:", "1", "pop"]);
        opcodes("`(2 * (3 + 5) / 4)", ["push_symbol", %Q{"("}, "push_symbol", %Q{"2"}, "push_symbol", %Q{"*"}, "push_symbol", %Q{"("}, "push_symbol", %Q{"3"}, "push_symbol", %Q{"+"}, "push_symbol", %Q{"5"}, "push_symbol", %Q{")"}, "push_symbol", %Q{"/"}, "push_symbol", %Q{"4"}, "push_symbol", %Q{")"}, "push_variable", "List", "push_integer", "11", "keyword", "new:", "1", "pop"]);
        opcodes("`(x = 2) eval", ["push_symbol", %Q{"("}, "push_symbol", %Q{"x"}, "push_symbol", %Q{"="}, "push_symbol", %Q{"2"}, "push_symbol", %Q{")"}, "push_variable", "List", "push_integer", "5", "keyword", "new:", "1", "unary", "eval", "pop"]);
    end

    it "emits for blocks" do
        opcodes("->(x = (x = 1, y = 2))", ["push_variable", "List", "push_0", "keyword", "new:", "1", "store", "x", "store", "x", "push_1", "store", "y", "push_2", "push_variable", "List", "push_2", "keyword", "new:", "1", "keyword", "params:function:", "2", "pop"]);
        opcodes("x = ->(
            :v1, :v2, (
                v1 += 1,
                v1 += 2,
        ...
        )", ["store", "x", "push_symbol", %Q{"v1"}, "push_symbol", %Q{"v2"}, "push_variable", "List", "push_2", "keyword", "new:", "1", "push_variable", "v1", "push_1", "binary", "+=", "push_variable", "v1", "push_2", "binary", "+=", "push_variable", "v1", "push_variable", "v2", "binary", "*", "push_variable", "List", "push_integer", "3", "keyword", "new:", "1", "keyword", "params:function:", "2", "pop"]);
        ...
        opcodes("->((x = 1, y = 2, x + y))", ["push_variable", "List", "push_0", "keyword", "new:", "1", "store", "x", "push_1", "store", "y", "push_2", "push_variable", "x", "push_variable", "y", "binary", "+", "push_variable", "List", "push_integer", "3", "keyword", "new:", "1", "keyword", "params:function:", "2", "pop"]);
        ...
        opcodes("->(x = 2) exec", ["push_variable", "List", "push_0", "keyword", "new:", "1", "store", "x", "push_2", "keyword", "params:function:", "2", "unary", "exec", "pop"]);
    ...
    it "emits for unary messages" do
        ...
        opcodes("x = obj puts", ["store", "x", "push_variable", "obj", "unary", "puts", "pop"]);
        ...
        opcodes("x = 42 incr incr decr decr", ["store", "x", "push_integer", "42", "unary", "incr", "unary", "incr", "unary", "decr", "unary", "decr", "pop"]);
    ...
    it "emits for binary messages" do
        ...
        opcodes("x = a + b * 2 - 5", ["store", "x", "push_variable", "a", "push_variable", "b", "binary", "+", "push_2", "binary", "*", "push_integer", "5", "binary", "-", "pop"]);
    ...
    it "emits for keyword messages" do
        ...
        opcodes("(
            ...
            x = list get: 2,
            x puts
        )", ["store", "list", "push_variable", "List", "unary", "new", "push_variable", "list", "push_integer", "42", "push_integer", "5", "keyword", "put:at:", "2", "store", "x", "push_variable", "list", "push_2", "keyword", "get:", "1", "push_variable", "x", "unary", "puts", "push_variable", "List", "push_integer", "4", "keyword", "new:", "1", "pop"]);
