...
module(identifiers_spec, {
    it("parses identifiers", {
        parse("(ident, 42, another)", vector_new(FM_LOCAL, string_new("ident"), FM_POP, FM_INTEGER, string_new("42"), FM_POP, FM_LOCAL, string_new("another"), FM_POP));
        parse("(stuff,ident2)", vector_new(FM_LOCAL, string_new("stuff"), FM_POP, FM_LOCAL, string_new("ident2"), FM_POP));
    });
