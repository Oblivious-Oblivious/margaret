...
module(bitstrings_spec, {
    it("parses bitstrings literals", {
        ...
        parse("{<0:1, 0:1, 1:1, 1:1}", marg_vector_new(FM_VARIABLE, marg_string_new("Bit"), FM_INTEGER, marg_string_new("0"), FM_INTEGER, marg_string_new("1"), FM_KEYWORD, marg_string_new("value:size:"), marg_string_new("2"), FM_VARIABLE, marg_string_new("Bit"), FM_INTEGER, marg_string_new("0"), FM_INTEGER, marg_string_new("1"), FM_KEYWORD, marg_string_new("value:size:"), marg_string_new("2"), FM_VARIABLE, marg_string_new("Bit"), FM_INTEGER, marg_string_new("1"), FM_INTEGER, marg_string_new("1"), FM_KEYWORD, marg_string_new("value:size:"), marg_string_new("2"), FM_VARIABLE, marg_string_new("Bit"), FM_INTEGER, marg_string_new("1"), FM_INTEGER, marg_string_new("1"), FM_KEYWORD, marg_string_new("value:size:"), marg_string_new("2"), FM_BITSTRING, marg_string_new("4")));
