...
module(booleans_spec, {
    it("parses boolean methods", {
        parse("(b = 2 == 3)", marg_vector_new(FM_2, FM_INTEGER, marg_string_new("3"), FM_BINARY, marg_string_new("=="), FM_STORE, marg_string_new("b")));
        parse("(b = 2 dosth!)", marg_vector_new(FM_2, FM_UNARY, marg_string_new("dosth!"), FM_STORE, marg_string_new("b")));
        ...
        parse("(b = (x < 5) && (y > 1))", marg_vector_new(FM_VARIABLE, marg_string_new("x"), FM_INTEGER, marg_string_new("5"), FM_BINARY, marg_string_new("<"), FM_VARIABLE, marg_string_new("y"), FM_1, FM_BINARY, marg_string_new(">"), FM_BINARY, marg_string_new("&&"), FM_STORE, marg_string_new("b")));
        parse("(b = (x < 5) || (y > 1))", marg_vector_new(FM_VARIABLE, marg_string_new("x"), FM_INTEGER, marg_string_new("5"), FM_BINARY, marg_string_new("<"), FM_VARIABLE, marg_string_new("y"), FM_1, FM_BINARY, marg_string_new(">"), FM_BINARY, marg_string_new("||"), FM_STORE, marg_string_new("b")));
        parse("(b = (x < 5) and: (y > 1))", marg_vector_new(FM_VARIABLE, marg_string_new("x"), FM_INTEGER, marg_string_new("5"), FM_BINARY, marg_string_new("<"), FM_VARIABLE, marg_string_new("y"), FM_1, FM_BINARY, marg_string_new(">"), FM_KEYWORD, marg_string_new("and:"), marg_string_new("1"), FM_STORE, marg_string_new("b")));
        parse("(b = (x < 5) or: (y > 1))", marg_vector_new(FM_VARIABLE, marg_string_new("x"), FM_INTEGER, marg_string_new("5"), FM_BINARY, marg_string_new("<"), FM_VARIABLE, marg_string_new("y"), FM_1, FM_BINARY, marg_string_new(">"), FM_KEYWORD, marg_string_new("or:"), marg_string_new("1"), FM_STORE, marg_string_new("b")));
        parse("(b = (x < 5) eqv: (y > 1))", marg_vector_new(FM_VARIABLE, marg_string_new("x"), FM_INTEGER, marg_string_new("5"), FM_BINARY, marg_string_new("<"), FM_VARIABLE, marg_string_new("y"), FM_1, FM_BINARY, marg_string_new(">"), FM_KEYWORD, marg_string_new("eqv:"), marg_string_new("1"), FM_STORE, marg_string_new("b")));
        parse("(b = (x < 5) xor: (y > 1))", marg_vector_new(FM_VARIABLE, marg_string_new("x"), FM_INTEGER, marg_string_new("5"), FM_BINARY, marg_string_new("<"), FM_VARIABLE, marg_string_new("y"), FM_1, FM_BINARY, marg_string_new(">"), FM_KEYWORD, marg_string_new("xor:"), marg_string_new("1"), FM_STORE, marg_string_new("b")));
