...
module(tensors_spec, {
    it("parses tensor literals", {
        ...
        parse("[42, \"Hello\", v1, v2]", vector_new(FM_INTEGER, string_new("42"), FM_STRING, string_new("Hello"), FM_VARIABLE, string_new("v1"), FM_VARIABLE, string_new("v2"), FM_TENSOR, string_new("4")));
