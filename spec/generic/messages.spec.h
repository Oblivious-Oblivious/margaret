...
module(messages_spec, {
    ...
    it("parses binary messages", {
        parse("2 + 3", marg_vector_new(FM_2, FM_INTEGER, marg_string_new("3"), FM_BINARY, marg_string_new("+")));
        parse("2 + 3 + 4 + 5", marg_vector_new(FM_2, FM_INTEGER, marg_string_new("3"), FM_BINARY, marg_string_new("+"), FM_INTEGER, marg_string_new("4"), FM_BINARY, marg_string_new("+"), FM_INTEGER, marg_string_new("5"), FM_BINARY, marg_string_new("+")));
        parse("2 * 5", marg_vector_new(FM_2, FM_INTEGER, marg_string_new("5"), FM_BINARY, marg_string_new("*")));
        ...
        parse("(41 + 1, 42 + 0, 43 - 1)", marg_vector_new(FM_INTEGER, marg_string_new("41"), FM_1, FM_BINARY, marg_string_new("+"), FM_INTEGER, marg_string_new("42"), FM_0, FM_BINARY, marg_string_new("+"), FM_INTEGER, marg_string_new("43"), FM_1, FM_BINARY, marg_string_new("-")));
        parse("((41 + 1), (42 + 0), (43 - 1))", marg_vector_new(FM_INTEGER, marg_string_new("41"), FM_1, FM_BINARY, marg_string_new("+"), FM_INTEGER, marg_string_new("42"), FM_0, FM_BINARY, marg_string_new("+"), FM_INTEGER, marg_string_new("43"), FM_1, FM_BINARY, marg_string_new("-")));
        parse("x = a + b * 2 - 5", marg_vector_new(FM_VARIABLE, marg_string_new("a"), FM_VARIABLE, marg_string_new("b"), FM_BINARY, marg_string_new("+"), FM_2, FM_BINARY, marg_string_new("*"), FM_INTEGER, marg_string_new("5"), FM_BINARY, marg_string_new("-"), FM_STORE, marg_string_new("x")));
        ...
        parse("[1, 2, 3] ++ [4, 5]", marg_vector_new(FM_1, FM_2, FM_INTEGER, marg_string_new("3"), FM_TENSOR, marg_string_new("3"), FM_INTEGER, marg_string_new("4"), FM_INTEGER, marg_string_new("5"), FM_TENSOR, marg_string_new("2"), FM_BINARY, marg_string_new("++")));
    ...
    it("parses keyword messages", {
        ...
        parse("( \
            ...
            x = list get: 2, \
            x puts \
        )", marg_vector_new(FM_VARIABLE, marg_string_new("List"), FM_UNARY, marg_string_new("new"), FM_STORE, marg_string_new("list"), FM_VARIABLE, marg_string_new("list"), FM_INTEGER, marg_string_new("42"), FM_INTEGER, marg_string_new("5"), FM_KEYWORD, marg_string_new("put:at:"), marg_string_new("2"), FM_VARIABLE, marg_string_new("list"), FM_2, FM_KEYWORD, marg_string_new("get:"), marg_string_new("1"), FM_STORE, marg_string_new("x"), FM_VARIABLE, marg_string_new("x"), FM_UNARY, marg_string_new("puts")));
        parse("2 + 3 incr add: 11", marg_vector_new(FM_2, FM_INTEGER, marg_string_new("3"), FM_UNARY, marg_string_new("incr"), FM_BINARY, marg_string_new("+"), FM_INTEGER, marg_string_new("11"), FM_KEYWORD, marg_string_new("add:"), marg_string_new("1")));
        parse("(1, 2, 3) reverse!: true", marg_vector_new(FM_1, FM_2, FM_INTEGER, marg_string_new("3"), FM_TRUE, FM_KEYWORD, marg_string_new("reverse!:"), marg_string_new("1")));
        parse("true then: 1 else: 2", marg_vector_new(FM_TRUE, FM_1, FM_2, FM_KEYWORD, marg_string_new("then:else:"), marg_string_new("2")));
        ...
        parse("(5 + 13) greater_than?: (11 + 2)", marg_vector_new(FM_INTEGER, marg_string_new("5"), FM_INTEGER, marg_string_new("13"), FM_BINARY, marg_string_new("+"), FM_INTEGER, marg_string_new("11"), FM_2, FM_BINARY, marg_string_new("+"), FM_KEYWORD, marg_string_new("greater_than?:"), marg_string_new("1")));
        parse("42 factorial and: (2 + 3)", marg_vector_new(FM_INTEGER, marg_string_new("42"), FM_UNARY, marg_string_new("factorial"), FM_2, FM_INTEGER, marg_string_new("3"), FM_BINARY, marg_string_new("+"), FM_KEYWORD, marg_string_new("and:"), marg_string_new("1")));
    ...
    it("chains keyword messages of exactly the same selector", {
        ...
        parse("arr add: 'a' at: 1 add: 'b' at: 2", marg_vector_new(FM_VARIABLE, marg_string_new("arr"), FM_CHAR, marg_string_new("a"), FM_1, FM_CHAR, marg_string_new("b"), FM_2, FM_KEYWORD, marg_string_new("add:at:add:at:"), marg_string_new("4")));
    });
