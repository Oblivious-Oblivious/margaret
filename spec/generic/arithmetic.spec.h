...
module(arithmetic_spec, {
    it("parses arithmetic expressions", {
        ...
        parse("(x = 6 - 3)", marg_vector_new(FM_INTEGER, marg_string_new("6"), FM_INTEGER, marg_string_new("3"), FM_BINARY, marg_string_new("-"), FM_STORE, marg_string_new("x")));
        parse("(x = 6 * 3)", marg_vector_new(FM_INTEGER, marg_string_new("6"), FM_INTEGER, marg_string_new("3"), FM_BINARY, marg_string_new("*"), FM_STORE, marg_string_new("x")));
        parse("(x = 1 + 2 * 3)", marg_vector_new(FM_1, FM_2, FM_BINARY, marg_string_new("+"), FM_INTEGER, marg_string_new("3"), FM_BINARY, marg_string_new("*"), FM_STORE, marg_string_new("x")));
        ...
        parse("(x = 5 raised_to: 2)", marg_vector_new(FM_INTEGER, marg_string_new("5"), FM_2, FM_KEYWORD, marg_string_new("raised_to:"), marg_string_new("1"), FM_STORE, marg_string_new("x")));
        parse("(x = 5 raised_to_integer: 2)", marg_vector_new(FM_INTEGER, marg_string_new("5"), FM_2, FM_KEYWORD, marg_string_new("raised_to_integer:"), marg_string_new("1"), FM_STORE, marg_string_new("x")));
        ...
        parse("(x = 3.99 round_to: 1)", marg_vector_new(FM_FLOAT, marg_string_new("3.99"), FM_1, FM_KEYWORD, marg_string_new("round_to:"), marg_string_new("1"), FM_STORE, marg_string_new("x")));
        parse("(x = 3.99 truncate_to: 1)", marg_vector_new(FM_FLOAT, marg_string_new("3.99"), FM_1, FM_KEYWORD, marg_string_new("truncate_to:"), marg_string_new("1"), FM_STORE, marg_string_new("x")));
        ...
        parse("(x = [0, 100] random)", marg_vector_new(FM_0, FM_INTEGER, marg_string_new("100"), FM_TENSOR, marg_string_new("2"), FM_UNARY, marg_string_new("random"), FM_STORE, marg_string_new("x")));
