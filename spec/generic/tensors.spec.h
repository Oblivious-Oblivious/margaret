...
module(tensors_spec, {
    it("parses tensor literals", {
        ...
        parse("[42, \"Hello\", 'x', v1, v2, (), [], {}, x = 1]", marg_vector_new(FM_INTEGER, marg_string_new("42"), FM_STRING, marg_string_new("Hello"), FM_CHAR, marg_string_new("x"), FM_VARIABLE, marg_string_new("v1"), FM_VARIABLE, marg_string_new("v2"), FM_TENSOR, marg_string_new("0"), FM_HASH, marg_string_new("0"), FM_INTEGER, marg_string_new("1"), FM_STORE, marg_string_new("x"), FM_TENSOR, marg_string_new("9")));
    });
})
