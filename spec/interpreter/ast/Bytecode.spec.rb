...
describe Bytecode do
    ...
    it "emits for binaries" do
        ...
        opcodes("(
            x = 0b0101 + 0b1011,
            x to_int puts,
        )", ["push_integer", "0b0101", "push_integer", "0b1011", "binary", "+", "store", "x", "push_variable", "x", "unary", "to_int", "unary", "puts", "pop"]);
    end
    ...
    it "emits for lists" do
        opcodes("()", []);
        opcodes("(1, 2, 3)", ["push_1", "push_2", "push_integer", "3", "pop"]);
        opcodes("(1, 2, (10, 20, 30), 3)", ["push_1", "push_2", "push_integer", "10", "push_integer", "20", "push_integer", "30", "push_integer", "3", "pop"]);
        opcodes(%Q{(1, "2", c, 42.42)}, ["push_1", "push_string", %Q{"2"}, "push_variable", "c", "push_float", "42.42", "pop"]);
    end
    ...
    it "emits for procs" do
        opcodes("->{x = (x = 1, y = 2)}", ["STARTpush_proc", "push_tensor", "0", "push_1", "store", "x", "push_2", "store", "y", "store", "x", "ENDpush_proc", "pop"]);
        opcodes("x = ->{
            v1, v2, (
                v1 += 1,
                v1 += 2,
        ...
        opcodes("->{42}", ["STARTpush_proc", "push_tensor", "0", "push_integer", "42", "ENDpush_proc", "pop"]);
        opcodes("->{a | a puts}", ["STARTpush_proc", "push_variable", "a", "push_tensor", "1", "push_variable", "a", "unary", "puts", "ENDpush_proc", "pop"]);
        opcodes("->{2 + 3}", ["STARTpush_proc", "push_tensor", "0", "push_2", "push_integer", "3", "binary", "+", "ENDpush_proc", "pop"]);
        opcodes("->{(x = 1, y = 2, x + y)}", ["STARTpush_proc", "push_tensor", "0", "push_1", "store", "x", "push_2", "store", "y", "push_variable", "x", "push_variable", "y", "binary", "+", "ENDpush_proc", "pop"]);
        opcodes("->{a, b | a + b}", ["STARTpush_proc", "push_variable", "a", "push_variable", "b", "push_tensor", "2", "push_variable", "a", "push_variable", "b", "binary", "+", "ENDpush_proc", "pop"]);
        opcodes("->{a, a}", ["STARTpush_proc", "push_variable", "a", "push_tensor", "1", "push_variable", "a", "ENDpush_proc", "pop"]);
        opcodes("->{x = 2} exec", ["STARTpush_proc", "push_tensor", "0", "push_2", "store", "x", "ENDpush_proc", "unary", "exec", "pop"]);
        opcodes("->{param | param puts} value: 42", ["STARTpush_proc", "push_variable", "param", "push_tensor", "1", "push_variable", "param", "unary", "puts", "ENDpush_proc", "push_integer", "42", "keyword", "value:", "1", "pop"]);
    end
    ...
    it "emits for assignment" do
        ...
        opcodes("x = (y = 6) + 1", ["push_integer", "6", "store", "y", "push_1", "binary", "+", "store", "x", "pop"]);
        opcodes("@x = x + 2", ["push_variable", "x", "push_2", "binary", "+", "store_instance", "x", "pop"]);
        opcodes("a = b = (c = 42) + 12", ["push_integer", "42", "store", "c", "push_integer", "12", "binary", "+", "store", "b", "store", "a", "pop"]);
    ...
    it "emits for unary messages" do
        ...
        opcodes("(obj puts, 42 incr)", ["push_variable", "obj", "unary", "puts", "push_integer", "42", "unary", "incr", "pop"]);
        opcodes("((obj puts), (42 incr))", ["push_variable", "obj", "unary", "puts", "push_integer", "42", "unary", "incr", "pop"]);
        ...
        opcodes("(42 one, 43 two, 44 three, 45, 46 four)", ["push_integer", "42", "unary", "one", "push_integer", "43", "unary", "two", "push_integer", "44", "unary", "three", "push_integer", "45", "push_integer", "46", "unary", "four", "pop"]);
        opcodes("p1 + p2 calc puts", ["push_variable", "p1", "push_variable", "p2", "unary", "calc", "unary", "puts", "binary", "+", "pop"]);
        opcodes("(p1 + p2 calc) puts", ["push_variable", "p1", "push_variable", "p2", "unary", "calc", "binary", "+", "unary", "puts", "pop"]);
    end
    ...
    it "emits for binary messages" do
        ...
        opcodes("(41 + 1, 42 + 0, 43 - 1)", ["push_integer", "41", "push_1", "binary", "+", "push_integer", "42", "push_0", "binary", "+", "push_integer", "43", "push_1", "binary", "-", "pop"]);
        opcodes("((41 + 1), (42 + 0), (43 - 1))", ["push_integer", "41", "push_1", "binary", "+", "push_integer", "42", "push_0", "binary", "+", "push_integer", "43", "push_1", "binary", "-", "pop"]);
        ...
        opcodes("(4 + 3) * (5 + 6)", ["push_integer", "4", "push_integer", "3", "binary", "+", "push_integer", "5", "push_integer", "6", "binary", "+", "binary", "*", "pop"]);
    end
    ...
    it "emits for keyword messages" do
        ...
        opcodes("list put: (42 incr) at: 5", ["push_variable", "list", "push_integer", "42", "unary", "incr", "push_integer", "5", "keyword", "put:at:", "2", "pop"]);
        opcodes("(
            list = List new,
            list put: 42 at: 5,
            x = list get: 2,
        ...
        opcodes("[1, 2, 3] reverse!: true", ["push_1", "push_2", "push_integer", "3", "push_tensor", "3", "push_true", "keyword", "reverse!:", "1", "pop"]);
        ...
        opcodes("(5 + 13) greater_than?: (11 + 2)", ["push_integer", "5", "push_integer", "13", "binary", "+", "push_integer", "11", "push_2", "binary", "+", "keyword", "greater_than?:", "1", "pop"]);
        opcodes("42 factorial and: (2 + 3)", ["push_integer", "42", "unary", "factorial", "push_2", "push_integer", "3", "binary", "+", "keyword", "and:", "1", "pop"]);
        opcodes("(list at: 3) + (list at: 5)", ["push_variable", "list", "push_integer", "3", "keyword", "at:", "1", "push_variable", "list", "push_integer", "5", "keyword", "at:", "1", "binary", "+", "pop"]);
        opcodes("arr add: 1 add: 2 add: 3", ["push_variable", "arr", "push_1", "keyword", "add:", "1", "push_variable", "arr", "push_2", "keyword", "add:", "1", "push_variable", "arr", "push_integer", "3", "keyword", "add:", "1", "push_tensor", "3", "pop"]);
    ...
    it "emits for keyword method definitions" do
        opcodes("#add: element at: position => 42", ["STARTpush_keyword_method", %Q{"add:at:"}, "push_variable", "element", "push_variable", "position", "push_tensor", "2", "push_integer", "42", "ENDpush_keyword_method", "pop"]);
        opcodes("#ok?: value1 otherwise!: value2 => 17", ["STARTpush_keyword_method", %Q{"ok?:otherwise!:"}, "push_variable", "value1", "push_variable", "value2", "push_tensor", "2", "push_integer", "17", "ENDpush_keyword_method", "pop"]);
    ...
    it "emits for C function definitions" do
        opcodes("###void f()", ["STARTpush_c_function", "push_variable", "void", "push_variable", "f", "push_tensor", "0", "ENDpush_c_function", "pop"]);
        opcodes("###void f2(int a, int b)", ["STARTpush_c_function", "push_variable", "void", "push_variable", "f2", "push_variable", "CFunParam", "push_variable", "int", "push_variable", "a", "keyword", "c_type:c_name:", "2", "push_variable", "CFunParam", "push_variable", "int", "push_variable", "b", "keyword", "c_type:c_name:", "2", "push_tensor", "2", "ENDpush_c_function", "pop"]);
    end
end
