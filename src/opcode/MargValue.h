...
#define IS_NIL(value)                                (!strncmp(QNAN_UNBOX(value)->name, "$nil", 4))
#define IS_FALSE(value)                              (!strncmp(QNAN_UNBOX(value)->name, "$false", 6))
#define IS_TRUE(value)                               (!strncmp(QNAN_UNBOX(value)->name, "$true", 5))
#define IS_INTEGER(value)                            (!strncmp(QNAN_UNBOX(value)->name, "$Integer", 8))
#define IS_FLOAT(value)                              (!strncmp(QNAN_UNBOX(value)->name, "$Float", 6))
#define IS_STRING(value)                             (!strncmp(QNAN_UNBOX(value)->name, "$String", 7))
#define IS_TENSOR(value)                             (!strncmp(QNAN_UNBOX(value)->name, "$Tensor", 7))
#define IS_HASH(value)                               (!strncmp(QNAN_UNBOX(value)->name, "$Hash", 5))
#define IS_OBJECT(value)                             (!strncmp(QNAN_UNBOX(value)->name, "$Object", 7))
#define IS_METHOD(value)                             (!strncmp(QNAN_UNBOX(value)->name, "$Method", 7))
#define IS_PROC(value)                               (!strncmp(QNAN_UNBOX(value)->name, "$Proc", 5))

#define IS_NIL_CLONE(value)                          IS_NIL((value))
#define IS_FALSE_CLONE(value)                        IS_FALSE((value))
#define IS_TRUE_CLONE(value)                         IS_TRUE((value))
#define IS_INTEGER_CLONE(value)                      (!strncmp(QNAN_UNBOX(value)->name, "$IntegerClone", 13))
#define IS_FLOAT_CLONE(value)                        (!strncmp(QNAN_UNBOX(value)->name, "$FloatClone", 11))
#define IS_STRING_CLONE(value)                       (!strncmp(QNAN_UNBOX(value)->name, "$StringClone", 12))
#define IS_TENSOR_CLONE(value)                       (!strncmp(QNAN_UNBOX(value)->name, "$TensorClone", 12))
#define IS_HASH_CLONE(value)                         (!strncmp(QNAN_UNBOX(value)->name, "$HashClone", 10))
#define IS_OBJECT_CLONE(value)                       (!strncmp(QNAN_UNBOX(value)->name, "$ObjectClone", 12))
#define IS_METHOD_CLONE(value)                       (!strncmp(QNAN_UNBOX(value)->name, "$MethodClone", 12))
#define IS_PROC_CLONE(value)                         (!strncmp(QNAN_UNBOX(value)->name, "$ProcClone", 10))
